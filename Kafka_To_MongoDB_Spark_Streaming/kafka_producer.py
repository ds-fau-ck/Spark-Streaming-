...
producer = KafkaProducer(
    bootstrap_servers='pkc-4j8dq.southeastasia.aws.confluent.cloud:9092',
    security_protocol='SASL_SSL',
    sasl_mechanism='PLAIN',
    sasl_plain_username='7TUSIFBKFOX4UR',
    sasl_plain_password='Ks4s1dZAgPEtSwRhTwxv5MprrvTd5oaLaZ6en79iYAgBTeoeZ8tJw',
