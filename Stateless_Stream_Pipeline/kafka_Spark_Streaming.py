...
df = spark \
    .readStream \
    .format("kafka") \
    .option("kafka.bootstrap.servers", "pkc-56d1g.eastus.aws.confluent.cloud:9092") \
    .option("subscribe", "user_data_topic") \
    .option("startingOffsets", "latest") \
    .option("kafka.security.protocol", "SASL_SSL") \
    .option("kafka.sasl.mechanism", "PLAIN") \
    .option("kafka.sasl.jaas.config", 
            f"org.apache.kafka.common.security.plain.PlainLoginModule required username='4MTJOS5G7HKCL' password='jdf/WNotpjtbpOlZbOaAXKwKiVtwSLZEbEg5YN1+3x7JEKpHQKuA0hK';") \
    .load()
